class Graph:
    ...
    #The main function that finds shortest distances from src to all other vertices using Bellman Ford algorithm. The function also detects negative weight ccle
    ...
    def BellmanFord(self, src):
        ...
        for _ in range(self.V - 1):
            #Update dist value and parent index of the adjacent vertices of the picked vertex. Consider only those vertices which are still in the queue
